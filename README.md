...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/60829e502133a8001794ff84
...
To start editing your site, you can use the Sanity interface at https://fierce-birch-29e50.sanity.studio/.
...
Generated at `2021-04-23T10:16:15.155Z` by Stackbit version `0.3.51-staging.0`.